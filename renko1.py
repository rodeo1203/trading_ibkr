...
ib = IB()
# util.patchAsyncio()
ib.connect("127.0.0.1", 7497, clientId=18)  # Replace with your connection details
...
# {Ticker(contract=Crypto(conId=479624278, symbol='BTC', exchange='PAXOS', currency='USD', localSymbol='BTC.USD', tradingClass='BTC'), time=datetime.datetime(2024, 2, 11, 9, 46, 54, 812161, tzinfo=datetime.timezone.utc), minTick=0.25, bid=48176.0, bidSize=1.0, ask=48176.25, askSize=1.0, last=48176.25, lastSize=1.0, volume=7.05041944, high=48283.5, low=48092.75, close=47545.0, halted=0.0, ticks=[TickData(time=datetime.datetime(2024, 2, 11, 9, 46, 54, 812161, tzinfo=datetime.timezone.utc), tickType=49, price=0.0, size=0)])}
